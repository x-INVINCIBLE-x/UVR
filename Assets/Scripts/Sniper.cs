...
public class Sniper : RangedWeapon
{
    ...
    protected override void PickUpWeapon(SelectEnterEventArgs args)
    {
        base.PickUpWeapon(args);
        scopeCam.SetActive(true);
    }

    protected override void DropWeapon(SelectExitEventArgs args)
    {
        base.DropWeapon(args);
        scopeCam.SetActive(false);
    }
