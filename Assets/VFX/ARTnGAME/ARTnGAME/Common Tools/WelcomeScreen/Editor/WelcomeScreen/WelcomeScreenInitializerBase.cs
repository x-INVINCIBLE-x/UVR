...
namespace Artngame.CommonTools.WelcomeScreen
{
    ...
    {
        protected static void HandleUnityStartup(System.Action openWindow, string getUpdatesUrl, AdditionalOnWindowOpened additionalOnWindowOpen = null)
        {
        ...
        private static void HandleEditorUpdate(System.Action openWindow, string getUpdatesUrl, AdditionalOnWindowOpened additionalOnWindowOpen = null)
        {
        ...
        private static void GetUpdates(System.Action openWindow, string getUpdatesUrl)
        {
        ...
        private static void OpenWindow(System.Action openWindow, AdditionalOnWindowOpened additionalOnWindowOpen, bool isFirstRun)
        {
            openWindow();
