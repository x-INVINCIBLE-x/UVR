...
Shader "SkyMaster/InfiniCloudsURP_CURVED"
{
	Properties
	{
		...
		_BendFade("Bend Fade", float) = 1.0
		_BendFadePower("Fade Power", Range(0.000001, 20)) = 1.0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 curveVertex(float4 vertex)
			{
				//float4 ws = mul(UNITY_MATRIX_M, v);//
				float3 positionWS = TransformObjectToWorld(vertex.xyz);
				float distance = length(positionWS.xyz - _BendCenter.xyz);
				distance = max(0, distance - _BendFade);

				distance = pow(distance, _BendFadePower);
				positionWS.xyz += distance * _BendPower;
				float3 positionOS = TransformWorldToObject(positionWS.xyz);
				return positionOS;// mul(_World2Object, positionWS);
			}
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				v.vertex.xyz = curveVertex(v.vertex);
				 ...
				 ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
						...
						float Thickness = 10;
						//float4 vortexPosRadius = float4(0, 0, 0, 1000);
						float distanceToVortexCenter = pow(length(vortexPosRadius.xz - WorldPosition.xz),1);
						float3x3 rotator = rotationMatrix(float3(0, 1, 0),  vortexControl.z * ((_Time.y * 0.5 * vortexControl.y) - vortexControl.x * 700 * (distanceToVortexCenter / 10000000)));
						//float3 posVertex = mul(float3(i.worldPos.x, 0, i.worldPos.z), rotator);//v0.7b
						float3 posVertexA = float3(WorldPosition.x, 0, WorldPosition.z);// vortexPosRadius;
						posVertexA = posVertexA - vortexPosRadius;
						float3 posVertex = mul(posVertexA, rotator);
						posVertex.y = WorldPosition.y;
						float diff = distanceToVortexCenter - 1500 * vortexControl.w;
						if (diff > 0) {//if (distanceToVortexCenter > 1500 * vortexControl.w) {
							posVertex = WorldPosition;
						}
						else {
							Thickness = Thickness / vortexControl.z;
						}
						float PosDiff = Thickness * 0.0006 * (_midYValue - WorldPosition.y) - 0.4;
						WorldPosition = posVertex ;
...
Node;AmplifyShaderEditor.RangedFloatNode;316;-1865.78,1663.554;Float;False;Property;_midYValue;midYValue;15;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;3.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;292;-1500.036,1822.61;Float;False;Property;_cloudHeight;cloudHeight;14;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;235;-972.8012,1783.112;Float;False;Property;_TaperPower;Taper Power;13;0;Create;True;0;0;0;False;0;False;2;1.23;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;393;-4103.905,2739.565;Float;False;Property;_BlendTweaker;Blend Tweaker;17;0;Create;True;0;0;0;False;0;False;1;0.123;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;368;38.4262,-367.1165;Float;False;Property;_SideLightingMultiplier;Side Lighting Multiplier;16;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;140;-3672.72,-1506.085;Float;False;Property;_SSSPower;SSS Power;11;0;Create;True;0;0;0;False;0;False;1;39.8;1;50;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;144;-3188.315,-1079.316;Float;False;Property;_SSSStrength;SSS Strength;12;0;Create;True;0;0;0;False;0;False;1;0.59;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;438;1710.745,-7.355268;Float;False;Property;_CloudColour;Cloud Colour;18;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;524;2250.795,131.013;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;SkyMaster/InfiniCloudsURP;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;23;Surface;1;638326142729488040;  Blend;0;0;Two Sided;0;638326230744461170;Forward Only;0;0;Cast Shadows;0;638326181033104990;  Use Shadow Threshold;0;0;Receive Shadows;0;638326160053243000;GPU Instancing;1;0;LOD CrossFade;0;638326160028035690;Built-in Fog;0;638326160020255400;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;False;True;False;False;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=A427475EA04F45576F75D2A0281DCB664824632F