...
Shader "Universal Render Pipeline/Lit (Nature Renderer)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        {
            Name "MotionVectors"
            Tags { "LightMode" = "MotionVectors"  "NatureRendererInstancing"="True" }
            ColorMask RG
        ...
        Pass
        {
            ...
            Tags { "LightMode" = "XRMotionVectors"  "NatureRendererInstancing"="True" }
            ColorMask RGBA
